...
# Conclusions Page
    ...
    *  ### How profitable is the gaming industry?
        ...
        3. Our findings mainly show that PS2, as a platform, has the lead in sales, accumulating over a billion in sales from all the games released in it, with most sales coming from North America. The platofrm X360 ranks second with nearly a billion in sales, also dominated by North American purchases. PS3 follows in third place with sales around 900 million in sales , split between Europe and North America, but still falling behind PS2 despite being a newer platform.
